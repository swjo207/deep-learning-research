...
model_path = './data/pm_model/binary_model.h5'
...
plt.show()
fig_acc.savefig("./data/pm_binary_model_accuracy.png")
...
plt.legend(['train', 'test'], loc='upper left')
plt.show()
fig_acc.savefig("./data/pm_binary_model_loss.png")
...
plt.show()
fig_verify.savefig("./data/pm_binary_model_verify.png")