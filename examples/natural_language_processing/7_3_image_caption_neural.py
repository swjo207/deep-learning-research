...
def define_model(vocab_size, max_length):
	...
	# summarize model
	model.summary()
	plot_model(model, to_file='model_img_caption.png', show_shapes=True)
	return model
...
checkpoint = ModelCheckpoint('model/model_img_caption.h5', monitor='val_loss', verbose=1, save_best_only=True, mode='min')
# fit model
...
# load the model
filename = 'model/model_img_caption.h5'
...
# extract features from each photo in the directory
def extract_feature_from_file(filename):
	# load the model
	model = VGG16()
	# re-structure the model
	model.layers.pop()
...
max_len = 34
# load the model
model = load_model('model/model_img_caption.h5')
# load and prepare the photograph
photo = extract_feature_from_file('data/example.jpg')
# generate description
